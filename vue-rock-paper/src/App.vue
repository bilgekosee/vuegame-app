...
<template>
  <div class="bg-red-400 text-red-900 text-center min-h-screen flex flex-col">
    <header class="container mx-auto p-6">
      <h1 class="text-4xl font-bold text-red-700">ROCK, PAPER, SCISSORS!</h1>
    </header>
    ...
    <main class="container mx-auto p-6 flex-1">
      ...
      >
        <button
          ...
          "
        >
          <img src="./assets/tas.svg" alt="Rock" class="w-full" />
        </button>
        ...
        <button
          ...
          "
        >
          <img src="./assets/kagit.svg" alt="Paper" />
        </button>
        ...
        <button
          ...
          "
        >
          <img src="./assets/makas.svg" alt="Scissors" />
        </button>
      </div>

      <div v-else>
        <div class="text-3xl mb-4">
          You picked <span class="text-green-500">{{ choice }}</span>
        </div>
        <div class="text-3xl mb-4">
          The computer picked
          <span class="text-yellow-400">{{ computerChoice }}</span>
        </div>
        <div class="text-6xl mb-12">
          {{ verdict }}
        </div>

        <button @click="ResetRound" class="bg-red-200 text-lg py-2 px-4">
          Reset
        </button>
      </div>
    ...
    <footer class="container mx-auto p-6">
      <a href="https://bilge-portfolio.netlify.app/"
        >This web page is made by Bilge KÖŞE
      </a>
    </footer>
  </div>
</template>
